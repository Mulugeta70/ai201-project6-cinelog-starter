...
Business logic for the watchlist feature. Film IDs are UUIDs throughout.
"""
...
def add_to_watchlist(user_id, film_id, public=None):
    ...
    Args:
        ...
        public (bool, optional): Whether the entry should be visible to
            other users. Defaults to the model default (private — see
            pr-response.md Comment 4) when not given explicitly.
